...
import { handleArtifactHub } from "@nghyane/pi-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@nghyane/pi-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@nghyane/pi-coding-agent/web/scrapers/discogs";
