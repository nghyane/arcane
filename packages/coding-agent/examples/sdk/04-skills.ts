 ...
 */
import { createAgentSession, discoverSkills, SessionManager, type Skill } from "@nghyane/arcane";

// Discover all skills from cwd/.arcane/skills, ~/.arcane/agent/skills, etc.
