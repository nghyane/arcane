...
```bash
npm install @nghyane/arcane-ai
```

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from "@nghyane/arcane-ai";
...
```typescript
import { Type, Tool, StringEnum } from "@nghyane/arcane-ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@nghyane/arcane-ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@nghyane/arcane-ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@nghyane/arcane-ai";
...
```typescript
import { getModel, stream } from "@nghyane/arcane-ai";
...
```typescript
import { getProviders, getModels, getModel } from "@nghyane/arcane-ai";
...
```typescript
import { Model, stream } from "@nghyane/arcane-ai";
...
```typescript
import { getModel, complete, Context } from "@nghyane/arcane-ai";
...
```typescript
import { Context, getModel, complete } from "@nghyane/arcane-ai";
...
bunx @nghyane/arcane-ai login vllm         # store vLLM API key (or placeholder for local no-auth)
bunx @nghyane/arcane-ai list               # list available providers
```
...
```typescript
import { loginGitHubCopilot } from "@nghyane/arcane-ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@nghyane/arcane-ai";
import * as fs from "node:fs";
