...
```bash
npm install @nghyane/pi-ai
```

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from "@nghyane/pi-ai";
...
```typescript
import { Type, Tool, StringEnum } from "@nghyane/pi-ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@nghyane/pi-ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@nghyane/pi-ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@nghyane/pi-ai";
...
```typescript
import { getModel, stream } from "@nghyane/pi-ai";
...
```typescript
import { getProviders, getModels, getModel } from "@nghyane/pi-ai";
...
```typescript
import { Model, stream } from "@nghyane/pi-ai";
...
```typescript
import { getModel, complete, Context } from "@nghyane/pi-ai";
...
```typescript
import { Context, getModel, complete } from "@nghyane/pi-ai";
...
bunx @nghyane/pi-ai login vllm         # store vLLM API key (or placeholder for local no-auth)
bunx @nghyane/pi-ai list               # list available providers
```
...
```typescript
import { loginGitHubCopilot } from "@nghyane/pi-ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@nghyane/pi-ai";
import * as fs from "node:fs";
